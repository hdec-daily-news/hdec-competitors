...
COMPANIES = {
    ...
    "삼성E&A": {
        "keywords": [
            "삼성E&A", "삼성엔지니어링", "삼성이앤에이",
            "삼성E&A 수주", "삼성E&A 플랜트", "삼성E&A 실적",
            "삼성E&A EPC", "삼성E&A 해외", "삼성E&A 계약", "삼성E&A 사업",
            "삼성E&A 기술", "삼성E&A 조직", "삼성E&A 대표", "삼성E&A 목표가",
        ],
        "identifier": ["삼성E&A", "삼성엔지니어링", "삼성이앤에이"],
        "color": "#1428a0",
    },
    "대우건설": {
        "keywords": [
    ...
    # ── 2026.7.31 8개사 개편분 (시공능력평가 공시 반영) ──
    "롯데건설": {
        "keywords": [
            "롯데건설", "롯데건설 수주", "롯데건설 분양", "롯데건설 착공",
            "롯데건설 시공", "롯데건설 재건축", "롯데건설 계약", "롯데건설 MOU",
            "롯데건설 입찰", "롯데건설 해외", "롯데건설 사업", "롯데건설 기술",
            "롯데건설 조직", "롯데건설 인사", "롯데건설 대표", "롯데건설 실적",
            "롯데건설 회사채",
            "르엘", "롯데캐슬",  # 브랜드명
        ],
        "identifier": ["롯데건설", "르엘", "롯데캐슬"],
        "exclude": ["롯데케미칼 실적", "롯데쇼핑", "롯데월드"],
        "color": "#e60012",
    },
    "포스코이앤씨": {
        "keywords": [
            "포스코이앤씨", "포스코이앤씨 수주", "포스코이앤씨 분양", "포스코이앤씨 착공",
            "포스코이앤씨 시공", "포스코이앤씨 재건축", "포스코이앤씨 계약", "포스코이앤씨 MOU",
            "포스코이앤씨 입찰", "포스코이앤씨 해외", "포스코이앤씨 사업", "포스코이앤씨 기술",
            "포스코이앤씨 조직", "포스코이앤씨 인사", "포스코이앤씨 대표", "포스코이앤씨 실적",
            "더샵", "오티에르",  # 브랜드명
        ],
        "identifier": ["포스코이앤씨", "더샵", "오티에르"],
        "exclude": ["포스코홀딩스", "포스코퓨처엠", "포스코인터내셔널"],
        "color": "#00a0e9",
    },
    "SK에코플랜트": {
        "keywords": [
            "SK에코플랜트", "에스케이에코플랜트",
            "SK에코플랜트 수주", "SK에코플랜트 분양", "SK에코플랜트 착공",
            "SK에코플랜트 시공", "SK에코플랜트 재건축", "SK에코플랜트 계약", "SK에코플랜트 MOU",
            "SK에코플랜트 입찰", "SK에코플랜트 해외", "SK에코플랜트 사업", "SK에코플랜트 기술",
            "SK에코플랜트 조직", "SK에코플랜트 인사", "SK에코플랜트 대표", "SK에코플랜트 실적",
            "SK뷰",  # 브랜드명
        ],
        "identifier": ["SK에코플랜트", "SK에코", "SK뷰"],
        "exclude": ["SK하이닉스", "SK이노베이션", "SK텔레콤"],
        "color": "#ea002c",
    },
}
...
<main class="container">
  ...
  <section class="hero">
    ...
    <p class="hero-desc">
      삼성물산 · 삼성E&amp;A · 대우건설 · GS건설 · DL이앤씨 · 롯데건설 · 포스코이앤씨 · SK에코플랜트<br>
      <strong>8개사 사업동향</strong>을 AI로 수집, 주요 경제지·종합지 기사만 선별합니다.
    </p>
